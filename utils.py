...
f_name_directory = 'D:/OneDrive/Desktop/mern project/The-Online-Exam-Proctor/static/OuputAudios'
# Capture
cap = None
...
def reduceBitRate (input_file,output_file):
   ...
   ffmpeg_path = "E:/ffmpeg/ffmpeg-2025-06-08-git-5fea5e3e11-full_build/bin/ffmpeg.exe"  # Replace with the actual path to ffmpeg.exe on your system
...
def deleteTrashVideos():
    global video
    video_folder = 'D:/OneDrive/Desktop/mern project/The-Online-Exam-Proctor/'
